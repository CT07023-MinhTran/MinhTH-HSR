<?php
// Bạn có thể xóa hoặc comment toàn bộ phần tạo bảng ở đây
?>
<!DOCTYPE html>
<html lang="vi">
<head>
    <meta charset="UTF-8">
    <title>Trang quản trị Honkai: Star Rail</title>
...
<body>
    ...
    <div class="admin-container">
        <div class="admin-sidebar">
            <ul>
                <li><a href="index.php" class="active">Trang chủ Admin</a></li>
